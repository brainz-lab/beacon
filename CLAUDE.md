...
cd /Users/afmp/brainz/brainzlab/beacon
...
# Example: Count monitors
kamal app exec -p --reuse -e SECRET_KEY_BASE:<master_key> 'bin/rails runner "puts UptimeMonitor.count"'
```
